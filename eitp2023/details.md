...
為確保公平參賽，大會將會對於隊伍裏面過往曾經參加過MR STEMer micro:bit AI編程大賽2021的選手實施加時平衡機制。

如有曾參加2021 AI編程大賽的選手參加是次比賽，請各隊伍於報名表格中如實申報。

### 加時平衡機制說明

假如隊伍裡面有再次參賽選手，隊伍的完成時間會按每名再賽選手加上1分鐘。

例子1: 假如隊伍的參賽選手包含4名再次參賽選手，該隊伍使用了10分鐘完成掃描所有密碼卡並獲得滿分。由於隊伍有2名再賽選手，隊伍的實際完成時間將改為10分鐘+1分鐘+1分鐘+1分鐘+1分鐘=14分鐘。

隊伍的最終分數為36分，所需時間為14分鐘。

例子2: 如隊伍的參賽選手包含2名再次參賽選手以及2名初次參賽選手，該隊伍在限時完結時獲得30分。於隊伍有2名再賽選手，隊伍的實際完成時間將改為15分鐘+1分鐘+1分鐘=17分鐘。

隊伍的最終分數為30分，所需時間為17分鐘。
